"""
Django settings for cold_paper_dev_66966 project.
...
ROOT_URLCONF = 'cold_paper_dev_66966.urls'
...
WSGI_APPLICATION = 'cold_paper_dev_66966.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_paper_dev_66966 API",
    "DESCRIPTION": "API documentation for cold_paper_dev_66966 App",
    "VERSION": "v1",
}
